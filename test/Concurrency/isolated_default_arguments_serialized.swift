...
// RUN: %target-swift-frontend %s -emit-sil -o /dev/null -verify -swift-version 6 -I %t
// RUN: %target-swift-frontend %s -emit-sil -o /dev/null -verify -swift-version 5 -I %t -enable-upcoming-feature IsolatedDefaultValues -strict-concurrency=complete
