...
// RUN: %target-swift-frontend -strict-concurrency=minimal -I %t -verify %s -o /dev/null -emit-sil
// RUN: %target-swift-frontend -strict-concurrency=targeted -I %t -verify %s -o /dev/null -emit-sil -verify-additional-prefix targeted-complete-
// RUN: %target-swift-frontend -strict-concurrency=complete -I %t -verify %s -o /dev/null -emit-sil -verify-additional-prefix complete- -verify-additional-prefix targeted-complete- -verify-additional-prefix tns-
