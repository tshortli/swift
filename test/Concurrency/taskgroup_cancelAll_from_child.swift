// RUN: %target-swift-frontend %s -emit-sil -o /dev/null -verify -verify-ignore-unrelated
// RUN: %target-swift-frontend %s -emit-sil -o /dev/null -verify -verify-ignore-unrelated -strict-concurrency=targeted
// RUN: %target-swift-frontend %s -emit-sil -o /dev/null -verify -verify-ignore-unrelated -strict-concurrency=complete
