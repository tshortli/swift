...
// RUN: %target-swift-frontend -strict-concurrency=targeted -I %t %s -o /dev/null -verify -verify-ignore-unrelated -emit-sil
// RUN: %target-swift-frontend -I %t %s -o /dev/null -verify -verify-ignore-unrelated -emit-sil -strict-concurrency=complete -verify-additional-prefix tns-
