...
// RUN: %target-swift-frontend -enable-implicit-dynamic -emit-module-path %t/OpaqueCrossFileB.swiftmodule -module-name OpaqueCrossFileB %S/Inputs/OpaqueCrossFileB.swift
// RUN: %target-swift-frontend -enable-implicit-dynamic -I %t -emit-ir -verify %s | %FileCheck %s
