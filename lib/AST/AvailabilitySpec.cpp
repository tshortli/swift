...
AvailabilitySpec *AvailabilitySpec::createWildcard(ASTContext &ctx, SourceLoc starLoc) {
  return new (ctx) AvailabilitySpec(AvailabilitySpecKind::Wildcard, std::nullopt,
                                    starLoc,
                                    /*Version=*/{},
                                    /*VersionStartLoc=*/{});
}
